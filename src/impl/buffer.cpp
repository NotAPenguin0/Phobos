...
static VkBufferUsageFlags get_usage_flags(BufferType buf_type) {
    ...
    case BufferType::AccelerationStructureInstance:
        return VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR;
