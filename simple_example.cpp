...
private:
    ...
    uint32_t bunny_material_idx;
    uint32_t ground_material_idx;
    
    ph::PointLight light;

    float bunny_rotation = 0;
public:
    SimpleExample() : ph::TestApplication(1280, 720, "Simple Example") {
        ...
        bunny = load_obj("data/dragon_scene/meshes/dragon.obj");
        bunny_color = load_texture("data/dragon_scene/textures/dragon_texture_color.png");
        ...
        ph::Material bunny_material;
        bunny_material.diffuse = &bunny_color;
        bunny_material.normal = &dragon_normal;
        bunny_material_idx = add_material(bunny_material);
    ...
    void update(ph::FrameInfo& frame, ph::RenderGraph& render_graph) override {
        ...
        glm::mat4 bunny_transform = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0, 0.0));
        bunny_transform = glm::scale(bunny_transform, glm::vec3(0.5, 0.5, 0.5));
        bunny_transform = glm::rotate(bunny_transform, glm::radians(bunny_rotation), glm::vec3(0.0f, 1.0f, 0.0f));

        glm::mat4 floor_transform = glm::mat4(1.0f);
        floor_transform = glm::translate(floor_transform, glm::vec3(0, -1, 0));
//        floor_transform = glm::rotate(floor_transform, glm::radians(30.0f * std::sin(time)), glm::vec3(1.0f, 0, 0));
        ...
        main_pass.transforms.push_back(bunny_transform);
        main_pass.transforms.push_back(floor_transform);
        main_pass.draw_commands.push_back(ph::RenderPass::DrawCommand{ &bunny, bunny_material_idx });
