...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginDragDropTargetCustom(const ImRect& bb, ImGuiID id);                                          // call after submitting an item that may receive a payload. If this returns true, you can call AcceptDragDropPayload() + EndDragDropTarget()
